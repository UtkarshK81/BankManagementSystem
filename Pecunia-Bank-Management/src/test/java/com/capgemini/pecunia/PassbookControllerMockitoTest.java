...
@SpringBootTest
public class PassbookControllerMockitoTest {
   ...
   public void testShouldGetAllTransactions() throws Exception{	
    ...
    public void testAccountValidation() throws Exception{
    	...
    	assertEquals(true, passbookService.accountValidation(10000001));
    }
    ...
    public void testUpdatePassbook() throws Exception{
        ...
        this.transactionList.add(new Transaction(001, "Credit", 4000.0, date1, null, ""));
        this.transactionList.add(new Transaction(002, "Credit", 4000.0,date2, null, ""));
        when(passbookService.updatePassbook(10000001)).thenReturn(transactionList);
    	assertEquals(2, passbookService.updatePassbook(10000001).size());
    }
}
